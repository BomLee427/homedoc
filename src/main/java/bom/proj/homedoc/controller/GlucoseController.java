...
public class GlucoseController {
     ...
     */
    @GetMapping("")
    public ResponseEntity<CommonResponse<List<GlucoseResponseDto>>> getGlucoseListV1(
        ...
        return ResponseEntity.ok(CommonResponse.getResponse(glucoseService.getGlucoseList(getCurrentUserPK().orElse(null), glucoseSearch, pageable)));
    }
    ...
    public ResponseEntity<CommonResponse<GlucoseStatisticResponseDto>> getGlucoseStatisticV1(
        ...
        return ResponseEntity.ok(CommonResponse.getResponse(glucoseService.getGlucoseStatistic(getCurrentUserPK().orElse(null), glucoseSearch)));
    }
    ...
    public ResponseEntity<CommonResponse<GlucoseResponseDto>> getGlucoseV1(
            @PathVariable Long measurementId
    ) {
        return ResponseEntity.ok(CommonResponse.getResponse(glucoseService.getGlucose(getCurrentUserPK().orElse(null), measurementId)));
    }
     ...
     */
    @PostMapping("")
    public ResponseEntity<CommonResponse<Map<String, Long>>> createGlucoseV1(
            @Validated @RequestBody final GlucoseCreateRequestDto dto) {
        return ResponseEntity.ok(CommonResponse.getResponse(Map.of("id", glucoseService.createGlucose(getCurrentUserPK().orElse(null), dto))));
    }
    ...
    public ResponseEntity<CommonResponse<GlucoseResponseDto>> updateGlucoseV1(
            @PathVariable Long measurementId,
            @Validated @RequestBody final GlucoseUpdateRequestDto dto
    ) {
        return ResponseEntity.ok(CommonResponse.getResponse(glucoseService.updateGlucose(getCurrentUserPK().orElse(null), measurementId, dto)));
    }
    ...
    public ResponseEntity<CommonResponse<Map<String, Long>>> deleteGlucoseV1(
            @PathVariable Long measurementId
    ) {
        return ResponseEntity.ok(CommonResponse.getResponse(Map.of("id", glucoseService.deleteGlucose(getCurrentUserPK().orElse(null), measurementId))));
    }
}
